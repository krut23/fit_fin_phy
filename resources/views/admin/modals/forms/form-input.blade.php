...
>
    ...
    {{--<div class="card-header card-header-content-between" style="border-top: 1px solid gray">
        <h4 class="card-header-title ng-binding">Edit Page Details</h4>
    </div>--}}
    ...
    <div class="mb-3">
        ...
        <ANY ng-switch="input.type">
            ...
            <!-- Custom Form Input -->
            @include('admin.modals.forms.form-input-custom')
                ...
                <div class="form-control select-ul @{{env.FormSettings.formInputSize}}" ng-init="selectUl()">
                    ...
                    <ul>
                        ...
                        <li class="option" ng-repeat="option in input.select.options | filter: input.select.search"
                            ...
                            {{-- ng-init="input.val == option.id ? input.select.label = option[input.select.key] : ''" --}}
                            >
