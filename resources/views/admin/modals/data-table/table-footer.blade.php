	...
	<div class="card-footer justify-content-center" ng-if="!pager.totalItems">
        <div class="dz-dropzone dz-dropzone-card c-default">
            <div class="dz-message">
                <img class="avatar avatar-xl avatar-4x3 mb-3" src="{{getAsset('svg/illustrations/oc-empty-cart.svg')}}" alt="Image Description" data-hs-theme-appearance="default">
