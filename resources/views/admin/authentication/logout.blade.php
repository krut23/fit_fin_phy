...
<main id="content" role="main" class="main">
    ...
    <div class="content container-fluid">
        <div class="row justify-content-sm-center text-center py-10">
            <div class="col-sm-7 col-md-5">
                <img class="img-fluid mb-5" src="{{getAsset('svg/illustrations/oc-collaboration.svg')}}"
                     alt="Image Description" data-hs-theme-appearance="default">
                <img class="img-fluid mb-5" src="{{getAsset('svg/illustrations-light/oc-collaboration.svg')}}"
                     alt="Image Description" data-hs-theme-appearance="dark">

                <h1>See you again!</h1>
                <p>Thanks for using {{env('app_name')}}. You are now successfully signed out.</p>
    ...
    <div class="footer">
        <div class="row justify-content-between align-items-center">
            <div class="col">
                <p class="fs-6 mb-0">&copy; {{env('APP_NAME')}}. <span class="d-none d-sm-inline-block">{{date('Y')}}</span></p>
            </div>
