...
<head>
    ...
    <link href="{{getAsset('css/custom-theme.css')}}" rel="stylesheet">
...
<!-- ========== MAIN CONTENT ========== -->
<main id="content" role="main" class="main custom-login" style="background-image: url('{{getAsset('img/auth-bg.png')}}') ">
    {{--    <div class="position-fixed top-0 end-0 start-0 bg-img-start" style="height: 32rem; background-image: url({{getAsset('svg/components/card-6.svg')}});">--}}
...
{{--            <img class="zi-2" src="{{getAsset('img/logo.png')}}" alt="Image Description" style="width: 20rem;">--}}
            <h1 class="text-secondary fw-bolder">{{ env('APP_NAME') }}</h1>
        </a>

        <div class="mx-auto" style="max-width: 30rem;">
            <!-- Card -->
            @if (session()->has('message'))
                <div class="alert alert-soft-danger" role="alert">{{ session('message') }}</div>
            @endif

            <div class="card card-lg mb-5">
                <div class="card-body">
                    <!-- Form -->
                    <form class="js-validate needs-validation" method="post" action="{{route('login.store')}}">
                        @csrf
...
<script src="{{getAsset('vendor/hs-toggle-password/dist/js/hs-toggle-password.js')}}"></script>
