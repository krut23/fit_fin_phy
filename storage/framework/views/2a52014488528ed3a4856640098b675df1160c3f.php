            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="all-form-reset">
                        ...
                        <div class="row">
                            <!-- Include input -->
                            <?php echo $__env->make('admin.modals.forms.form-input', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- End Include input-->
                        </div>
                        <!-- End Row -->
                    </form>
...
<!-- End Form Modal -->
<?php /**PATH C:\xampp\htdocs\fit-fin-phy (1)\fit-fin-phy\resources\views/admin/modals/forms/form-modal.blade.php ENDPATH**/ ?>