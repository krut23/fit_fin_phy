    <!-- Card -->
        <div class="card _dataTable">
                ...
                <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" ng-class="{'table-hover': !isShowTableLoader}">
                    ...
                    <tbody>
                        <tr ng-repeat="row in pager.filteredData">
                            ...
                            <!-- Table row data -->
                            <?php echo $__env->make('admin.modals.data-table.table-row-data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <!-- Table row data end -->

                            <!-- Table row status status -->
                            <?php echo $__env->make('admin.modals.data-table.table-row-data-status', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="table_row_action_dropdown_{{ row.index }}">
                                        <ANY ng-repeat="(key, button) in tableRowActionButton">
                                            <ANY ng-if="button.isShow" ng-switch="key">
                                                ...
                                                <?php echo $__env->make('admin.modals.data-table.table-row-action-button-custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <!-- Table body -->
                    <?php echo $__env->make('admin.modals.data-table.table-loader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- End Table body -->
            ...
            <!-- Footer -->
            <?php echo $__env->make('admin.modals.data-table.table-footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!-- End Footer -->
        </div>
        <!-- End Card -->
<?php /**PATH C:\xampp\htdocs\fit-fin-phy (1)\fit-fin-phy\resources\views/admin/modals/data-table/data-table.blade.php ENDPATH**/ ?>